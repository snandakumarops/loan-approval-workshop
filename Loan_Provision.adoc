...
. Download the Applicant.java file from link:resources/Applicant.java[this] location and add it to the package you’ve just created.


. Download the 'Loan.java' file from link:resources/Loan.java[this] location and add it to the package.
