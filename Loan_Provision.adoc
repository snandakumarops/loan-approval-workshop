...
. Download the Applicant.java file from link:resources/interest_rate_calculation.xls[this] location and add it to the package you’ve just created.


. Download the 'Loan.java' file from this location and add it to the package.
